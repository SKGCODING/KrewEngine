...
namespace KrewEngine {
    ...
    void BatchRenderer2D::init() {
        ...
        glVertexAttribPointer(SHADER_UV_INDEX, 2, GL_FLOAT, GL_FALSE, RENDERER_VERTEX_SIZE, (const GLvoid*) sizeof(GLfloat));
        glVertexAttribPointer(SHADER_TID_INDEX, 1, GL_FLOAT, GL_FALSE, RENDERER_VERTEX_SIZE, (const GLvoid*) sizeof(GLfloat));
        glVertexAttribPointer(SHADER_COLOR_INDEX, 4, GL_UNSIGNED_BYTE, GL_TRUE, RENDERER_VERTEX_SIZE, (const GLvoid*) sizeof(GLfloat));
        ...
        void BatchRenderer2D::Submit(const RenderData2D* renderable) {
        ...
        void BatchRenderer2D::DrawString(const std::string& text, const Maths::Vector3 position,const Font& font, unsigned int color) {
            ...
            if (!found) {
                ...
                if (m_TextureSlots.size() >= RENDER_MAX_TEXTURES) {
