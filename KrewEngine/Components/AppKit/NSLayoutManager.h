...
- (void)setGlyphs:(const CGGlyph *)glyphs properties:(const NSGlyphProperty *)props characterIndexes:(const NSUInteger *)charIndexes font:(NSFont *)aFont forGlyphRange:(NSRange)glyphRange NS_AVAILABLE(10_11, 7_0);
...
- (NSRect)lineFragmentRectForGlyphAtIndex:(NSUInteger)glyphIndex effectiveRange:(nullable NSRangePointer)effectiveGlyphRange withoutAdditionalLayout:(BOOL)flag NS_AVAILABLE(10_0, 9_0);
...
- (void)enumerateEnclosingRectsForGlyphRange:(NSRange)glyphRange withinSelectedGlyphRange:(NSRange)selectedRange inTextContainer:(NSTextContainer *)textContainer usingBlock:(void (^)(NSRect rect, BOOL *stop))block NS_AVAILABLE(10_11, 7_0);
...
- (NSUInteger)layoutManager:(NSLayoutManager *)layoutManager shouldGenerateGlyphs:(const CGGlyph *)glyphs properties:(const NSGlyphProperty *)props characterIndexes:(const NSUInteger *)charIndexes font:(NSFont *)aFont forGlyphRange:(NSRange)glyphRange NS_AVAILABLE(10_11, 7_0);
...
- (CGFloat)layoutManager:(NSLayoutManager *)layoutManager lineSpacingAfterGlyphAtIndex:(NSUInteger)glyphIndex withProposedLineFragmentRect:(NSRect)rect NS_AVAILABLE(10_11, 7_0);

// Returns the paragraph spacing before the line starting with glyphIndex.
- (CGFloat)layoutManager:(NSLayoutManager *)layoutManager paragraphSpacingBeforeGlyphAtIndex:(NSUInteger)glyphIndex withProposedLineFragmentRect:(NSRect)rect NS_AVAILABLE(10_11, 7_0);

// Returns the paragraph spacing after the line ending with glyphIndex.
- (CGFloat)layoutManager:(NSLayoutManager *)layoutManager paragraphSpacingAfterGlyphAtIndex:(NSUInteger)glyphIndex withProposedLineFragmentRect:(NSRect)rect NS_AVAILABLE(10_11, 7_0);
...
- (NSFont *)substituteFontForFont:(NSFont *)originalFont NS_DEPRECATED_MAC(10_0, 10_11);


- (void)insertGlyphs:(const NSGlyph *)glyphs length:(NSUInteger)length forStartingGlyphAtIndex:(NSUInteger)glyphIndex characterIndex:(NSUInteger)charIndex NS_DEPRECATED_MAC(10_0, 10_11, "Use -setGlyphs:properties:characterIndexes:font:forGlyphRange instead");
- (void)insertGlyph:(NSGlyph)glyph atGlyphIndex:(NSUInteger)glyphIndex characterIndex:(NSUInteger)charIndex NS_DEPRECATED_MAC(10_0, 10_11, "Use -setGlyphs:properties:characterIndexes:font:forGlyphRange instead");
- (void)replaceGlyphAtIndex:(NSUInteger)glyphIndex withGlyph:(NSGlyph)newGlyph NS_DEPRECATED_MAC(10_0, 10_11, "Use -setGlyphs:properties:characterIndexes:font:forGlyphRange instead");
- (void)deleteGlyphsInRange:(NSRange)glyphRange NS_DEPRECATED_MAC(10_0, 10_11, "Use -setGlyphs:properties:characterIndexes:font:forGlyphRange instead");
- (void)setCharacterIndex:(NSUInteger)charIndex forGlyphAtIndex:(NSUInteger)glyphIndex NS_DEPRECATED_MAC(10_0, 10_11, "Use -setGlyphs:properties:characterIndexes:font:forGlyphRange instead");
- (void)setIntAttribute:(NSInteger)attributeTag value:(NSInteger)val forGlyphAtIndex:(NSUInteger)glyphIndex NS_DEPRECATED_MAC(10_0, 10_11, "Use -setGlyphs:properties:characterIndexes:font:forGlyphRange instead");
- (void)invalidateGlyphsOnLayoutInvalidationForGlyphRange:(NSRange)glyphRange NS_DEPRECATED_MAC(10_5, 10_11, "Use -setGlyphs:properties:characterIndexes:font:forGlyphRange instead");

- (NSInteger)intAttribute:(NSInteger)attributeTag forGlyphAtIndex:(NSUInteger)glyphIndex NS_DEPRECATED_MAC(10_0, 10_11, "Use -getGlyphsInRange:glyphs:properties:characterIndexes:bidiLevels: instead");
...
- (NSUInteger)getGlyphs:(nullable NSGlyph *)glyphArray range:(NSRange)glyphRange NS_DEPRECATED_MAC(10_0, 10_11, "Use -getGlyphsInRange:glyphs:properties:characterIndexes:bidiLevels: instead");

- (void)invalidateLayoutForCharacterRange:(NSRange)charRange isSoft:(BOOL)flag actualCharacterRange:(nullable NSRangePointer)actualCharRange NS_DEPRECATED_MAC(10_0, 10_11, "Use -invalidateLayoutForCharacterRange:actualCharacterRange: instead");
- (void)textStorage:(NSTextStorage *)str edited:(NSTextStorageEditedOptions)editedMask range:(NSRange)newCharRange changeInLength:(NSInteger)delta invalidatedRange:(NSRange)invalidatedCharRange NS_DEPRECATED_MAC(10_0, 10_11, "Use -processEditingForTextStorage:edited:range:changeInLength:invalidatedRange: instead");

- (void)setLocations:(NSPointArray)locations startingGlyphIndexes:(NSUInteger *)glyphIndexes count:(NSUInteger)count forGlyphRange:(NSRange)glyphRange NS_DEPRECATED_MAC(10_5, 10_11, "Use -setLocation:forStartOfGlyphRange: instead");
