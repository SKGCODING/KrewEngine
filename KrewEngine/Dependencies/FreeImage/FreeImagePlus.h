...
public:
    ...
    /** @brief Returns a pointer to the start of the given scanline in the bitmapís data-bits.
    ...
    /**
     8-bit transparency : get the bitmapís transparency table.
     @return Returns a pointer to the bitmapís transparency table.
     @see FreeImage_GetTransparencyTable
     */
    BYTE* getTransparencyTable() const;
    
    /**
     8-bit transparency : set the bitmapís transparency table.
